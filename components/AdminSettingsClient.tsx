        ...
        <form onSubmit={handleSave} className="dashboard-grid mt-4">
          <div className="card glass-panel col-span-2">
            ...
            <div className="flex-col gap-1 mt-1">
               <label htmlFor="carsPrompt" className="text-secondary">برومبت اختبار CARS (Autism Assessment)</label>
               <textarea 
                 id="carsPrompt"
                 title="CARS prompt"
            ...
            <div className="flex-col gap-1 mt-2">
               <label htmlFor="generalSummary" className="text-secondary">برومبت التلخيص العام للجلسات</label>
               <textarea 
                 id="generalSummary"
                 title="General summary prompt"
                 className="input-field glass-panel w-full min-h-150px"
